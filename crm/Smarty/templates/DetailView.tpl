			...
			{if $MODULE eq 'Potentials' || $MODULE eq 'HelpDesk' || $MODULE eq 'Contacts' || $MODULE eq 'Accounts' || $MODULE eq 'Leads' || ($MODULE eq 'Documents' && ($ADMIN eq 'yes' || $FILE_STATUS eq '1') && $FILE_EXIST eq 'yes')}
  			<table width="100%" border="0" cellpadding="5" cellspacing="0">
				...
				<tr><td align="left" style="padding-left: 10px;">
						<a class="webMnu" href="custom_merge/stc.php?return_id={$ID}" target="_blank" title=""><img hspace="5" align="absmiddle" border="0" src="themes/images/bookMark.gif">STC Assignment Form (merge)</a>
						</td>
				</tr>
				<tr><td align="left" style="padding-left: 10px;">
						<a class="webMnu" href="custom_merge/connectionform.php?return_id={$ID}" target="_blank" title=""><img hspace="5" align="absmiddle" border="0" src="themes/images/bookMark.gif">PV Solar Connection Form (merge)</a>
						</td>
				</tr>
				<tr><td align="left" style="padding-left: 10px;">
				...
				<tr><td align="left" style="padding-left: 10px;">
						<a class="webMnu" href="custom_stock/index.php?return_id={$ID}" target="_blank" title=""><img hspace="5" align="absmiddle" border="0" src="themes/images/bookMark.gif">Generate Stock Log</a>
						</td>
				</tr>
				<!-- Custom For GFS Quote Module Start -->
				<tr><td>&nbsp;</td></tr>	
				<tr><td align="left" class="genHeaderSmall">Quotes</td></tr>
				<tr><td align="left" style="padding-left: 10px;"><a class="webMnu" href="index.php?module=QuotePrice&action=index&parenttab=Sales&record={$ID}" target="_blank" title=""><img hspace="5" align="absmiddle" border="0" src="themes/images/bookMark.gif">Get me a quote!</a></td></tr>
				
				<tr><td align="left" style="padding-left: 10px;">{$QUOTES}</td></tr>
				...
				<tr><td align="left" style="padding-left: 10px;">
						...
						<a style="cursor: pointer;" onclick="show_distributor({$ID})">Search based on postcode</a>
				</td></tr>
