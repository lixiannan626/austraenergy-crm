...
alt="Clear" title="Clear" LANGUAGE=javascript	onClick="this.form.{$fldname}.value=''; this.form.{$fldname}_display.value=''; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
		...
		{elseif $uitype eq 19 || $uitype eq 20}
			...
			<td width=80% class="dvtCellInfo" align=left colspan="3">
				<textarea class="detailedViewTextBox" tabindex="{$vt_tab}" onFocus="this.className='detailedViewTextBoxOn'" name="{$fldname}"  onBlur="this.className='detailedViewTextBox'" cols="90" rows="4">{$fldvalue}</textarea>
		...
		{elseif $uitype eq 53}
			...
			<td width="30%" align=left class="dvtCellInfo">
				...
				<span id="assign_user" style="{$style_user} display:inline-block;">
				...
				{if $secondvalue neq ''}
					<span id="assign_team" style="display: inline-block; {$style_group} ">
		...
		{elseif $uitype eq 23 || $uitype eq 5 || $uitype eq 6}
			...
			<td width="30%" align=left class="dvtCellInfo">
				...
				<input name="{$fldname}" tabindex="{$vt_tab}" id="jscal_field_{$fldname}" type="text" style="border:1px solid #bababa; padding: 5px; margin: 5px 0;" size="11" maxlength="10" value="{$date_val}">
				<img src="{'btnL3Calendar.png'|@vtiger_imageurl:$THEME}" id="jscal_trigger_{$fldname}" height="19" style="cursor: pointer; position: relative; top: 4px;">
