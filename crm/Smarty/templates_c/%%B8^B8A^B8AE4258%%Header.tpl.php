<?php /* Smarty version 2.6.18, created on 2013-07-03 15:17:25
         compiled from Header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Header.tpl', 97, false),array('modifier', 'escape', 'Header.tpl', 105, false),array('modifier', 'getTranslatedString', 'Header.tpl', 131, false),array('modifier', 'vtlib_purify', 'Header.tpl', 403, false),array('function', 'math', 'Header.tpl', 652, false),)), $this); ?>
...
"></script>
	...
	<?php if ($this->_tpl_vars['MODULE_NAME'] != 'QuotePrice'): ?>
	...
	<?php endif; ?>
	<?php if ($this->_tpl_vars['MODULE_NAME'] != 'InstallArrangement' && $this->_tpl_vars['MODULE_NAME'] != 'InstallPaperwork' && $this->_tpl_vars['MODULE_NAME'] != 'StockManager' && $this->_tpl_vars['MODULE_NAME'] != 'Standardization' && $this->_tpl_vars['MODULE_NAME'] != 'QuotePrice' && $this->_tpl_vars['MODULE_NAME'] != 'SimpleSettings'): ?>
...
.js"></script>
	<?php endif; ?>
	 ...
	 <script type="text/javascript">
		var cre = <?php echo $this->_tpl_vars['CURRENT_USER_ID']; ?>
;
	 </script>
	<?php if ($this->_tpl_vars['MODULE_NAME'] != 'QuotePrice'): ?>
	<script language="JavaScript" type="text/javascript" src="include/js/download.js"></script>  
	<?php endif; ?>
    ...
    <!-- END -->
		...
		<?php if ($this->_tpl_vars['HEADERSCRIPTS'] && $this->_tpl_vars['MODULE_NAME'] != 'QuotePrice'): ?>
...
" style="display: none;"/>
	...
	<TABLE border=0 cellspacing=0 cellpadding=0 width=100% class="hdrNameBg" id="top-banner">
	<tr>
		<td valign=top><img src="<?php echo vtiger_imageurl('crm-header.png', $this->_tpl_vars['THEME']); ?>
" alt="vtiger CRM" title="vtiger CRM" border=0 height="53"></td>
...
" class="drop_down"><?php echo $this->_tpl_vars['headerlink_label']; ?>
			...
			<?php endif; ?>
						 ...
						 <?php if ($this->_tpl_vars['ADMIN_LINK'] != ''): ?> 						 <?php endif; ?>
...
<div id='miniCal' style='position:absolute; display:none; left:100px; top:100px; z-index:100000'>
</div>
...
<tr>
	<td style="width:14px" class=small>&nbsp;</td>
	<td class=small nowrap> 
		<table border=0 cellspacing=0 cellpadding=0 id="header_nav_0109">
...
?>
			 <?php if ($this->_tpl_vars['maintabs'] != 'Marketing' && $this->_tpl_vars['maintabs'] != 'My Home Page'): ?>
...
"></td>
			...
			<td class="tabUnSelected"><a href="tutorials.php">Tutorials</a></td>
		...
		<table border=0 cellspacing=0 cellpadding=0 id="search" style="border:1px solid #999999;background-color:white">
		   <tr>
			...
			<td style="height:19px;background-color:#ffffef" nowrap>
				<a href='javascript:void(0);' onclick="UnifiedSearch_SelectModuleForm(this);"><img src="<?php echo vtiger_imageurl('settings_top.png', $this->_tpl_vars['THEME']); ?>
