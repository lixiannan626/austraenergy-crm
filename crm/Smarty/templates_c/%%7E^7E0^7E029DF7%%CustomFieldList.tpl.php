<?php /* Smarty version 2.6.18, created on 2011-12-16 19:33:04
         compiled from modules/Calendar/CustomFieldList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'modules/Calendar/CustomFieldList.tpl', 94, false),array('modifier', 'vtlib_getModuleTemplate', 'modules/Calendar/CustomFieldList.tpl', 120, false),)), $this); ?>
...
" border="0" height="48" width="48" onmouseover="tooltip.tip(this,'<?php echo $this->_tpl_vars['MOD']['LEADS_CUSTOM_FIELD_MAPPING']; ?>
...
unset($_smarty_tpl_vars);
 ?>
                ...
                <div id="cfList">
                                <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => vtlib_getModuleTemplate('Calendar', 'CustomFieldEntries.tpl'), 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
                </div>	
