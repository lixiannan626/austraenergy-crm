<?php /* Smarty version 2.6.18, created on 2013-07-02 23:07:17
        ...
        <div id="locateMap" onMouseOut="fninvsh('locateMap')" onMouseOver="fnvshNrm('locateMap')">
                <table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                               ...
                               <?php if ($this->_tpl_vars['MODULE'] == 'Contacts'): ?>
										<a href="javascript:;" onClick="fninvsh('locateMap'); searchMapLocation( 'Main' );" class="calMnu">Installation address</a>
                                        <a href="javascript:;" onClick="fninvsh('locateMap'); searchMapLocation( 'Other' );" class="calMnu">Postal address</a>
                               <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
		...
		<td width=22% valign=top style="1display:none;border-left:1px dashed #cccccc;padding:13px">
			...
			<?php if ($this->_tpl_vars['MODULE'] == 'Potentials' || $this->_tpl_vars['MODULE'] == 'HelpDesk' || $this->_tpl_vars['MODULE'] == 'Contacts' || $this->_tpl_vars['MODULE'] == 'Accounts' || $this->_tpl_vars['MODULE'] == 'Leads' || ( $this->_tpl_vars['MODULE'] == 'Documents' && ( $this->_tpl_vars['ADMIN'] == 'yes' || $this->_tpl_vars['FILE_STATUS'] == '1' ) && $this->_tpl_vars['FILE_EXIST'] == 'yes' )): ?>
  			<table width="100%" border="0" cellpadding="5" cellspacing="0">
				...
				<!-- Custom For GFS Merge Start-->
				<tr><td>&nbsp;</td></tr>				
				<tr><td align="left" class="genHeaderSmall">Job Pack Documents</td></tr>
				<tr><td align="left" style="padding-left: 10px;">
						<a class="webMnu" href="custom_merge/stc.php?return_id=<?php echo $this->_tpl_vars['ID']; ?>
" target="_blank" title=""><img hspace="5" align="absmiddle" border="0" src="themes/images/bookMark.gif">STC Assignment Form (merge)</a>
						</td>
				</tr>
				<tr><td align="left" style="padding-left: 10px;">
						<a class="webMnu" href="custom_merge/connectionform.php?return_id=<?php echo $this->_tpl_vars['ID']; ?>
" target="_blank" title=""><img hspace="5" align="absmiddle" border="0" src="themes/images/bookMark.gif">PV Solar Connection Form (merge)</a>
						</td>
				</tr>
				<tr><td align="left" style="padding-left: 10px;">
						<a class="webMnu" href="custom_merge/EWR.pdf" target="_blank" title=""><img hspace="5" align="absmiddle" border="0" src="themes/images/bookMark.gif">EWR</a>
						</td>
				</tr>
				<tr><td>&nbsp;</td></tr>				
				<tr><td align="left" class="genHeaderSmall">Stock Management</td></tr>
				<tr><td align="left" style="padding-left: 10px;">
						<a class="webMnu" href="custom_stock/index.php?return_id=<?php echo $this->_tpl_vars['ID']; ?>
" target="_blank" title=""><img hspace="5" align="absmiddle" border="0" src="themes/images/bookMark.gif">Generate Stock Log</a>
						</td>
				</tr>
				<!-- Custom For GFS Quote Module Start -->
				<tr><td>&nbsp;</td></tr>	
				<tr><td align="left" class="genHeaderSmall">Quotes</td></tr>
				<tr><td align="left" style="padding-left: 10px;"><a class="webMnu" href="index.php?module=QuotePrice&action=index&parenttab=Sales&record=<?php echo $this->_tpl_vars['ID']; ?>
" target="_blank" title=""><img hspace="5" align="absmiddle" border="0" src="themes/images/bookMark.gif">Get me a quote!</a></td></tr>
				
				<tr><td align="left" style="padding-left: 10px;"><?php echo $this->_tpl_vars['QUOTES']; ?>
</td></tr>
				
				<!-- Custom For GFS Quote Module End -->
				
				<!-- Custom For GFS Distributor 2013-7-2 Start -->
				<tr><td>&nbsp;</td></tr>	
				<tr><td align="left" class="genHeaderSmall">Find distributor (Beta)</td></tr>
				<tr><td align="left" style="padding-left: 10px;">
						<img src="themes/images/settings_top.png" align="left" border="0">
						<a style="cursor: pointer;" onclick="show_distributor(<?php echo $this->_tpl_vars['ID']; ?>
)">Search based on postcode</a>
				</td></tr>
				<tr><td><div id="distributor-result"></div></td></tr>
				<?php echo '
				<script>
				function show_distributor(id) {
					new Ajax.Request(\'modules/Contacts/ajax-distributor.php\', 
					{
						method: \'post\',
						postBody: \'id=\'+document.getElementById("dtlview_Installation Post Code").innerHTML+\'&Random=\'+Math.random()+\'&field=postcode\',
						onComplete: function(response) {
							document.getElementById("distributor-result").innerHTML = response.responseText;
						}
					})
				}
