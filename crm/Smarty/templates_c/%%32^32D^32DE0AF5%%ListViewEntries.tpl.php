<?php /* Smarty version 2.6.18, created on 2012-03-14 01:58:05
...
')"/>
                    <?php elseif ($this->_tpl_vars['button_check'] == 'mass_edit'): ?>
                         <input id="mass_edit_button" class="crmbutton small edit" type="button" value="<?php echo $this->_tpl_vars['button_label']; ?>
