<?php /* Smarty version 2.6.18, created on 2012-09-30 22:06:28
...
"  onBlur="this.className='detailedViewTextBox'" cols="90" rows="4"><?php echo $this->_tpl_vars['fldvalue']; ?>
</textarea>
...
><?php echo $this->_tpl_vars['sel_value']; ?>
				...
				<?php if ($this->_tpl_vars['secondvalue'] != ''): ?>
					<span id="assign_team" style="display: inline-block; <?php echo $this->_tpl_vars['style_group']; ?>
 ">
...
_mass_edit_check" class="small" ><?php endif; ?>
			...
			<td width="30%" align=left class="dvtCellInfo">
				<input readonly name="account_name" style="border:1px solid #bababa; margin: 5px 0; padding: 5px;" type="text" value="<?php echo $this->_tpl_vars['fldvalue']; ?>
...
" type="text" style="border:1px solid #bababa; padding: 5px; margin: 5px 0;" size="11" maxlength="10" value="<?php echo $this->_tpl_vars['date_val']; ?>
">
				<img src="<?php echo vtiger_imageurl('btnL3Calendar.png', $this->_tpl_vars['THEME']); ?>
" id="jscal_trigger_<?php echo $this->_tpl_vars['fldname']; ?>
" height="19" style="cursor: pointer; position: relative; top: 4px;">
...
?>
				...
				<?php if ($this->_tpl_vars['uitype'] == 5 || $this->_tpl_vars['uitype'] == 23): ?>
					<font size=1><em old="(yyyy-mm-dd)">(<?php echo $this->_tpl_vars['dateStr']; ?>
)</em></font>
				<?php else: ?>
					<font size=1><em old="(yyyy-mm-dd)">(<?php echo $this->_tpl_vars['dateStr']; ?>
)</em></font>
