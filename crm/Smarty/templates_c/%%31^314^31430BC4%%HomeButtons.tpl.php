<?php /* Smarty version 2.6.18, created on 2012-09-30 00:18:27
...
">
	...
	<td align='left'>
		<img width="27" height="27" onClick='fnAddWindow(this,"addWidgetDropDown");' onMouseOut='fnRemoveWindow();' src="<?php echo vtiger_imageurl('btnL3Add.png', $this->_tpl_vars['THEME']); ?>
...
<?php if ($this->_tpl_vars['CHECK']['Calendar'] == 'yes' && $this->_tpl_vars['CALENDAR_ACTIVE'] == 'yes' && $this->_tpl_vars['CALENDAR_DISPLAY'] == 'true'): ?>
	<td>
		<img width="27" height="27" src="<?php echo vtiger_imageurl('btnL3Calendar.png', $this->_tpl_vars['THEME']); ?>
...
<?php if ($this->_tpl_vars['WORLD_CLOCK_DISPLAY'] == 'true'): ?>
	<td>
		<img width="27" height="27" src="<?php echo vtiger_imageurl('btnL3Clock.png', $this->_tpl_vars['THEME']); ?>
...
<?php if ($this->_tpl_vars['CALCULATOR_DISPLAY'] == 'true'): ?>
	<td>
		<img width="27" height="27" src="<?php echo vtiger_imageurl('btnL3Calc.png', $this->_tpl_vars['THEME']); ?>
...
<?php if ($this->_tpl_vars['CHAT_DISPLAY'] == 'true'): ?>
	<td>
		<img width="27" height="27" src="<?php echo vtiger_imageurl('tbarChat.png', $this->_tpl_vars['THEME']); ?>
...
<?php endif; ?>
	<td>
		<img width="27" height="27" src="<?php echo vtiger_imageurl('btnL3Tracker.png', $this->_tpl_vars['THEME']); ?>
...
" border="0" onClick="fnvshobj(this,'tracker');">
	...
	<td>
		<img width="27" height="27" src="<?php echo vtiger_imageurl('btnL3AllMenu.png', $this->_tpl_vars['THEME']); ?>
