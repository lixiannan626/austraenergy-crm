<?php /* Smarty version 2.6.18, created on 2012-09-30 22:13:50
         compiled from Buttons_List1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'Buttons_List1.tpl', 17, false),)), $this); ?>
...
..." border=0></a></td>
			                       	<?php endif; ?>
					<?php else: ?>
						<td style="padding-right:0px;padding-left:10px;"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
btnL3Add-Faded.png" border=0></td>	
					<?php endif; ?>
									
						<td style="padding-right:10px"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
btnL3Search-Faded.png" border=0></td>
...
" border="0"></a></td>	
				<?php else: ?>	
					<td style="padding-right:0px;padding-left:10px;"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
tbarImport-Faded.png" border="0"></td>	
				<?php endif; ?>	
...
" border="0"></a></td>			
				...
				<?php else: ?>	
					<td style="padding-right:10px"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
tbarExport-Faded.png" border="0"></td>
                <?php endif; ?>
			<?php else: ?>
				<td style="padding-right:0px;padding-left:10px;"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
tbarImport-Faded.png" border="0"></td>
...
&action=FindDuplicateRecords&button_view&list_view"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
...
" border="0"></a></td>
				<?php else: ?>
					<td style="padding-right:10px"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
FindDuplicates-Faded.png" border="0"></td>	
				<?php endif; ?>
			<?php else: ?>
				<td style="padding-right:10px"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
FindDuplicates-Faded.png" border="0"></td>
...
&parenttab=Settings'><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
settingsBox.png" alt="<?php echo ((is_array($_tmp=$this->_tpl_vars['MODULE'])) ? $this->_run_mod_handler('getTranslatedString', true, $_tmp, $this->_tpl_vars['MODULE']) : getTranslatedString($_tmp, $this->_tpl_vars['MODULE'])); ?>
