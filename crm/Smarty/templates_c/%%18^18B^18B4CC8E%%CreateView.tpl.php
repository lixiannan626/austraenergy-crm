<?php /* Smarty version 2.6.18, created on 2012-09-30 21:42:14
         compiled from CreateView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtlib_purify', 'CreateView.tpl', 33, false),array('modifier', 'getTranslatedString', 'CreateView.tpl', 74, false),array('modifier', 'cat', 'CreateView.tpl', 80, false),)), $this); ?>
...
?>
								   <tr>
									...
									<td colspan=2 class="detailedViewHeader">
                                                                        ...
                                                                        <td class="detailedViewHeader">
                                                                        <input name="cpy" onclick="return copyAddressLeft(EditView)" type="radio"><b>Copy Postal address</b></td>
                                                                        <td class="detailedViewHeader">
                                                                        <input name="cpy" onclick="return copyAddressRight(EditView)" type="radio"><b>Copy Installation address</b></td>
                                                                        <?php else: ?>
