...
if(count($rows) != 0)
{
	...
	";
	$exp = "You can click the detail comment to determine whether the job has been cancelled, etc.";
	ShowTable($v, "confirm_vic_div", "Job status hasn't been confirmed by installer/customer", $exp, "vic");
	
	ShowTable($q, "confirm_qld_div", "Job status hasn't been confirmed by installer/customer", $exp, "qld");
