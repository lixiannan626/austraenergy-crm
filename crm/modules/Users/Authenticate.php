...
else
{
	...
	foreach ($rowList as $row) {
		...
		//Change compared php version to 5.4.0 to avoid error appearing due to xampp upgrade from 1.7.0 to 1.7.4
		if(strtolower($cryptType) == 'md5' && version_compare(PHP_VERSION, '5.4.0') >= 0) {
