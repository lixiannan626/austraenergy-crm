...
<div align="center">	
	...
	<table border="0" cellspacing="0" cellpadding="0" width=300>
		<tr>
			<td class="bg" width="70%"><img src="themes/images/vtigerName.gif" alt="vtiger CRM" title="vtiger CRM"></td>
			<td class="bg" align="right" width="30%"><img src="themes/images/honestCRM.gif" alt="The honest Open Source CRM" title="The honest Open Source CRM"></td>
		</tr>
		<tr>
			<!--<td class="small z1" align="center"><img src="themes/images/bullets.gif"></td>-->
	       		<td class="small z2" colspan="2" align="center">
			<?php
			...
			<!-- Sign in form -->
				...
				<input type="hidden" name="return_action" value="Login">
					...
					<tr>
						...
						<!--<td class="small" colspan="2"><p style="color: red;">Update on May 15, 2012: Access your Sales Report through Nav Bar <strong>Sales</strong>-><strong>Sales Report</strong>.</p></td>
					</tr>
					<tr>
						<td class="small" colspan="2"><p style="color: black;">Update on Feb 13, 2012: Sales are only able to edit <strong>Sales Progress</strong>, <strong>Comment</strong> and <strong>Sales Follow Up Date</strong>.</p></td>
					</tr>-->
					<tr>
					...
					<tr>
						...
						<!-- form elements -->
							...
							<!--customised for goforsolar: comment out two useless trs. -->
							<?php
							
							/*
							<tr class="useless" bgcolor="#f5f5f5">
							...
							*/
							...
							<tr>
								...
								<!--<p style="color: #F46B25; ">Note: It's a good habit to input <strong>appointment date</strong> and keep <strong>sales progress</strong> updated.</p>-->
